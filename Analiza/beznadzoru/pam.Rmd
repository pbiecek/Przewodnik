...
Niestety jak widzieliśmy, opiera się on o kwadrat odległości Euklidesowej. Nie zawsze akurat taka miara podobieństwa nas interesuje. Taka miara jest też bardzo wrażliwa na duże oedległości i pojedyncza wartość odstająca może znaczącu wpłynąć na sumę kwadratów odległości.
...
2. Dla każej grupy, sprawdź czy inny obiekt z tej grupy nie ma mniejszej sumy odległości od wszystkich pozostałych w tej grupie. Jeżeżeli tak, to on opowinien być nowym medoidem.
...
Przypomnijemy wykres przedstawoający wybrane parametry dla wybranych marek.
...
Wykorzystajmy obie te wartości aby narysować auta po podzieleniu na grupy. Dodatkowo wyróżnimy średoki grup.
...
Im bliższa $$s(i)$$ wartości 1, tym bardziej dany obiekt pasuje do swojej grupy, im bliższa wartości -1, tyb bliżej temu obiektowi do grupy sąsiedniej.
