...
```{r glosowania, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
library(ggplot2)
library(ggrepel)
library(MASS)
library(cluster)
...
```{r glosowania2, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
ggplot(projekcja, aes(V1, V2, label=imie)) + 
  geom_point(aes(color=klub)) +
  geom_text_repel(data=projekcja[c(268, 348, 139, 259, 168, 309, 223),]) 
```
...
```{r glosowania3, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
...
```{r glosowania4, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
ggplot(projekcja, aes(V1, V2, label=imie)) + 
  geom_point(aes(color=klub)) +
  geom_text_repel(data=projekcja[c(268, 348, 139, 259, 168, 309, 223),]) 
```
