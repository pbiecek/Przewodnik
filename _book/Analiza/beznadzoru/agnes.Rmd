...
```{r hclust_complete, warning=FALSE, message=FALSE, dev='svg', fig.width=8, fig.height=6}
...
```{r hclust_cutree, warning=FALSE, message=FALSE, dev='svg', fig.width=8, fig.height=8}
...
```{r hclust_gap, warning=FALSE, message=FALSE, dev='svg', fig.width=8, fig.height=8}
...
```{r hclust_klastrowanie, warning=FALSE, message=FALSE, dev='svg', fig.width=8, fig.height=8}
