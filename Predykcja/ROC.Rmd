...
Mając klasyfikaor, często potrzebujemy narzędzia, które pozwoli ocenić jego jakość.
...
Funkcją `varImpPlot` możemy pokazac ranking ważności zmiennych. 
...
Aby ocenić jakość klasyfikatora można wykrozystać całą krzywą ROC lub pole pod nią - AUC.
