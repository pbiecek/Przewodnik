...
Funkcja `group_by()` pozwala okreslić w jakich grupach mają być liczone agregaty wyznaczane przez funkcję `summarise()`.
...
Jeżeli jakaś kombinacja grup w danych nie występuje (np. `Model = Beetle` i `Rodzaj.paliwa = benzyna+LPG`) to nei pojawi się też w agregatach.
