...
$$
Co już łatwo zrobić, to rozwiązaniem jest reguła decyzyjna minimalizująca bład predykcji z zadanymi wagami $w_i$.
...
Taką funkcję jednej zmiennej $\alpha$ łatwo już rowziązać. Oznaczając przez $res_i$
$$
...
Wielu gurów ML uważa że boosting jest lepszy od baggingu, ale w praktyce bywa różnie.
...
Nie można jako argumenty podać formułę, trzeba samemu wyznaczyć ektor y i kolumne X.
