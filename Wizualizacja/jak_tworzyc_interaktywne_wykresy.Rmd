...
Najłatwiejszy sposób aby budować interaktywne wykresy w R, to skorzystanie z pakietu `rCharts` (https://ramnathv.github.io/rCharts/).
...
Szczegółowa lista dostępnych opcji znajduje się na [tej stronie](https://ramnathv.github.io/rCharts/).
